...
<PlatformsBreadcrumb platform="Render" icon={
  <>
...
<Note>
  Deploying to [Render](http://render.com) takes more steps than we want to document here. Follow their [docker guide](https://docs.render.com/docker#docker-builds-on-render) (Render recognizes your `Dockerfile` automatically) and then return to this page. This guide will give the examples in Docker.
</Note>
...
For Render, do the same. Set your `DOTENV_PRIVATE_KEY_PRODUCTION` in the environment variable manager.

<ScreenshotBrowser url="/assets/docs/render-vars.png" www="render.com" />
