...
<Note>
  If you prefer, [install directly form GitHub Releases](/docs/install#git-hub-releases) or view the [installer.sh file](https://dotenvx.sh/installer.sh) before executing.
</Note>
