...
import DockerComposeRunCodeGroup from '@/pages/partials/dockerComposeRunCodeGroup.mdx'
import DockerfileComposeCodeGroup from '@/pages/partials/dockerfileComposeCodeGroup.mdx'
import DockerComposeCodeGroup from '@/pages/partials/dockerComposeCodeGroup.mdx'
import DockerfileComposeDotenvxCodeGroup from '@/pages/partials/dockerfileComposeDotenvxCodeGroup.mdx'
import DockerComposeDotenvxCodeGroup from '@/pages/partials/dockerComposeDotenvxCodeGroup.mdx'
import DockerComposeDotenvxRunProductionLocalCodeGroup from '@/pages/partials/dockerComposeDotenvxRunProductionLocalCodeGroup.mdx'
...
<PlatformsBreadcrumb platform="Docker Compose" icon={
  <>
...
<Note>
  Find <a href="https://github.com/dotenvx/examples/tree/main/platforms/docker-compose">code examples for this guide</a> on GitHub.
</Note>
...
<DockerfileComposeCodeGroup/>

Create a `docker-compose.yml` file.

<DockerComposeCodeGroup/>
...
Install [`dotenvx`](https://github.com/dotenvx/dotenvx) to your Dockerfile.

<DockerfileComposeDotenvxCodeGroup/>
...
<DockerComposeDotenvxRunProductionLocalCodeGroup/>
