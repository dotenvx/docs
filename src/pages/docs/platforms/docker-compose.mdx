...
<Note>
  If you prefer, [install directly form GitHub Releases](/docs/learn/installing#git-hub-releases) or view the [install.sh file](https://dotenvx.sh/install.sh) before executing.
</Note>
