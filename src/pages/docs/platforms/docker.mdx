...
<ScreenshotBrowser url="/assets/img/docs/hello-blank.png" www="docker container" />
...
<ScreenshotBrowser url="/assets/img/docs/hello-production.png" www="docker container" />
