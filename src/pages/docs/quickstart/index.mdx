...
The fastest way to use `dotenvx` anywhere, across multiple environments, and with encryption. {{ className: 'lead' }} 
...
See [other ways to install](/docs/install), like Windows executables, standalone GitHub releases, and more.
