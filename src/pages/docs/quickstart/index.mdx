...
You can combine multiple environments too – for instance a `.env.local` file.
...
Or use built-in conventions like [Next.js's convention](/docs/advanced/run-convention-nextjs).
