...
You can also keep private keys in a password manager and load them at runtime. See [Use dotenvx with 1Password](/docs/guides/1password) or [Use dotenvx with Bitwarden](/docs/guides/bitwarden).
