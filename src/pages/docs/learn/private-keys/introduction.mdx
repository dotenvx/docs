...
* **With Vault ⛨:** written remotely to your account – as an armored key.
...
<RenderableTabs variant="code">
  ...
  <RenderableTab title="with Vault ⛨">
    <img
...
Vault ⛨ users can additionally view all their private keys in the [UI](https://vlt.dotenvx.com).

<ScreenshotBrowser url='https://github.com/user-attachments/assets/3e8943da-9358-4e6d-89e4-8c5d604c5095' www='vlt.dotenvx.com' />
