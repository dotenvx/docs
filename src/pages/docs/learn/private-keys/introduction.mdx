...
* **With Vlt ⛨:** written remotely to your account – as an armored key.
...
Vlt ⛨ users can additionally view all their private keys in the [UI](https://ops.dotenvx.com).
