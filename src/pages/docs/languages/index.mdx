...
export const description =
  'Use dotenvx across multiple languages.'

##### [dotenvx](/docs)
# Languages

Examples of using `dotenvx` with multiple languages. {{ className: 'lead' }}
...
<div className="my-16 xl:max-w-none">
  <div className="not-prose mt-4 grid grid-cols-1 gap-x-6 gap-y-10 border-t border-zinc-900/5 pt-10 dark:border-white/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
    ...
    <div key="java" className="flex flex-row-reverse gap-6">
      <div className="flex-auto">
        <h3 className="text-sm font-semibold text-zinc-900 dark:text-white">
          Java
        </h3>
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use dotenvx with Java</p>
        <p className="mt-1"><Button href="/docs/languages/java" variant="text" arrow="right">Java Guides</Button></p>
      </div>
      <JavaIcon className="h-10 w-10 text-[#5382A1] dark:text-white"/>
    </div>
    <div key="dotnet" className="flex flex-row-reverse gap-6">
      <div className="flex-auto">
        <h3 className="text-sm font-semibold text-zinc-900 dark:text-white">
          .NET
        </h3>
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use dotenvx with .NET</p>
        <p className="mt-1"><Button href="/docs/languages/dotnet" variant="text" arrow="right">.NET Guides</Button></p>
      </div>
      <DotnetIcon className="h-10 w-10 text-[#512BD4]"/>
    </div>
