...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/nodejs/google-cloud-build">code example on GitHub</a> for this guide.
</Note>
...
Set your project. You can look this up on the [Google Cloud Dashboard](https://console.cloud.google.com/).
