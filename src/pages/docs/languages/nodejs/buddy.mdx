...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/nodejs/buddy">code example on GitHub</a> for this guide.
</Note>
...
<ScreenshotBrowser url='/assets/img/docs/buddy-hello-undefined.png' www='buddy.works/org/app/pipelines' />
...
<ScreenshotBrowser url='/assets/img/docs/buddy-ci-config-vars.gif' www='buddy.works' />
...
<ScreenshotBrowser url='/assets/img/docs/buddy-logs-vault.png' www='buddy.works' />
