...
<Note>
  The below framework guides all assume the presence of a `.env` file containing `HELLO=World`. Find <a href="https://github.com/dotenvx/examples/tree/master/package-managers/npm">code examples on GitHub</a>.
</Note>
