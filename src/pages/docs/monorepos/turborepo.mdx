...
<PackageManagersBreadcrumb manager="turborepo" icon={
  <>
...
Adjust your `package.json` scripts to inject your env using `dotenvx`.
...
<ScreenshotBrowser url="/assets/docs/hello-blank.png" www="localhost:3002" />
...
Modify your `package.json` scripts to use the `.env.production` file.
