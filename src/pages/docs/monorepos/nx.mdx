...
Install [`dotenvx`](https://github.com/dotenvx/dotenvx) via [brew](/docs/learn/installing#brew), [npm](/docs/learn/installing#npm), or [other options](/docs/learn/installing). Here I'm using brew.
