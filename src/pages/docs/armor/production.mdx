export const description =
  'Deploy with `dotenvx armor`'

##### [Armor](/docs/armor)
# Production

Ready to deploy to production? Here's how with  `dotenvx` and `dotenvx armor`. {{ className: 'lead' }}

Deploying to production with `dotenvx armor` is the same as deploying with `dotenvx`.
