...
Integrate with your GitHub account and track encrypted secret changes in your Pull Requests. Protect yourself and your team against accidently pushing `.env` files as well.
